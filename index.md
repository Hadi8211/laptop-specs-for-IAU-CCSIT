...
💡 **نصيحة ذهبية للمستجدين:** في السنة الأولى، ستدرسون مواد عامة وأساسيات برمجة (مثل Python أو Java) لا تتطلب مواصفات عالية. **لا تتسرعوا في شراء لابتوب غالي الثمن ومختص الآن!** استخدموا أي جهاز متوفر لديكم حاليا، وعندما تتخصصون في السنة القادمة، اشتروا الجهاز المناسب لتخصصكم الدقيق.
</div>

إذا كنت مضطرا لشراء جهاز الآن بسبب عدم امتلاكك لواحد نهائيا، ننصحك بشراء جهاز مستعمل بسعر اقتصادي جدا (أقل من 200 دولار) يلبي هذه المواصفات الأساسية لتمشية الحال:

| المكون (Component) | المواصفات الأساسية (Basic Requirements) |
| :--- | :--- |
| **نظام التشغيل (OS)** | Windows 10 / 11 |
| **الذاكرة العشوائية (RAM)** | 8 GB - 16 GB |
| **المعالج (CPU)** | Intel Core i5 / AMD Ryzen 5 (الجيل الثامن فما فوق) |
| **مساحة التخزين (SSD)** | 256 GB - 512 GB SSD |
| **كرت الشاشة (GPU)** | كرت شاشة مدمج (Integrated) يكفي تماما |

<details class="sub-details">
<summary>💻 أجهزة اقتصادية مقترحة (رخيصة وعملية)</summary>
<ul>
<li><strong>أجهزة ممتازة بأسعار منخفضة جدا:</strong> ThinkPad T480, Dell Latitude 7490, HP EliteBook 840 G5/G6.</li>
</ul>
</details>
...
اللابتوب هو الأساس ولا غنى عنه. إذا لم يكن لديك أي كمبيوتر حاليا، فيجب عليك شراء لابتوب كخيار أول ووحيد لتتمكن من كتابة وتطبيق الأكواد البرمجية الأساسية. التابلت (مثل الآيباد) جهاز ممتاز جدا لقراءة الملازم وتدوين الملاحظات، ولكنه يعتبر جهازا ثانويا مكملا وليس بديلا. 

نقطة هامة جدا: بعض الاختبارات الجامعية تتطلب استخدام متصفح مراقبة خاص اسمه Lockdown Browser. قد تواجه بعض المشاكل والصعوبات التقنية إذا كنت تستخدم تابلت بدلا من لابتوب لأداء هذه الاختبارات، علما بأن هذا المتصفح متاح فقط لأنظمة ويندوز وماك ونظام الآيباد (iPadOS).

الخلاصة: إذا كانت ميزانيتك تسمح بجهاز واحد فقط، فاشتر لابتوب. أما إذا كان لديك لابتوب يفي بالغرض حاليا، فشراء تابلت لتسهيل المذاكرة يعتبر خطوة إضافية ممتازة.
</details>
...
<details markdown="1">
<summary>لماذا تنصحون بأجهزة الأعمال (Workstations) بدلا من لابتوبات الألعاب (Gaming Laptops)؟</summary>
